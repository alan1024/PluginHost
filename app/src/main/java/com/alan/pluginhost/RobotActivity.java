...
public class RobotActivity extends AppCompatActivity {
    ...
    public class RobotAdapter extends BaseMultiItemQuickAdapter<ChatMsgBean, BaseViewHolder> {
        ...
        @Override
        protected void convert(@NonNull BaseViewHolder helper, ChatMsgBean item) {

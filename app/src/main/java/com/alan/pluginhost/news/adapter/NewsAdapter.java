...
import com.alan.pluginhost.utils.ImageLoaderUtils;
...
//        LayoutInflater localInflater = LayoutInflater.from(mContext).cloneInContext(contextThemeWrapper);
        ...
        if (viewType == TYPE_ITEM) {
            View v = LayoutInflater.from(mContext).inflate(R.layout.item_sex, null);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof ItemViewHolder) {
            ...
            if (news.getImgsrc() == null) {
                ((ItemViewHolder) holder).mNewsImg.setImageResource(R.mipmap.ic_logo);
            } else {

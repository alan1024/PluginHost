...
//                        DiskCacheManager manager = new DiskCacheManager(HostApp.getInstance(), Constants.CACHE_ZHIHU_FILE);
...
//                });
    ...
    public void loadCache() {
        final DiskCacheManager manager = new DiskCacheManager(HostApp.getInstance(), Constants.CACHE_ZHIHU_FILE);

package com.alan.pluginhost.http.manager;


import android.util.SparseArray;

import com.alan.pluginhost.HostApp;
import com.alan.pluginhost.http.Api;
import com.alan.pluginhost.http.HostType;
import com.alan.pluginhost.http.service.NewsService;
...
public class RetrofitManager {
    ...
    private Interceptor mRewriteCacheControlInterceptor = new Interceptor() {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            if (NetUtil.isConnected(HostApp.getInstance())) {
        ...
        if (sOkHttpClient == null) {
            synchronized (RetrofitManager.class) {
                if (sOkHttpClient == null) {
                    ...
                    // 指定缓存路径,缓存大小100Mb
                    Cache cache = new Cache(new File(HostApp.getInstance().getCacheDir(), "HttpCache"), 1024 * 1024 * 100);

...
import com.alan.pluginhost.adapter.GroupedGridLayoutManager;
import com.alan.pluginhost.adapter.GroupedListAdapter;
import com.alan.pluginhost.bean.ChannelItem;
import com.alan.pluginhost.bean.GroupItem;
import com.alan.pluginhost.listener.OnChannelItemClicklistener;
import com.alan.pluginhost.listener.UserActionListener;
import com.alan.pluginhost.util.MeasureUtil;
...
public class ChannelTagView extends LinearLayout {
    ...
    public ChannelTagView(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public ChannelTagView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        final ChannelItem removeItem =  unAddedGroups.get(groupPosition).getChannelItems().remove(childposition);
    ...
    private class ChannelAdapter extends CommonAdapter<ChannelItem> {
        ...
        protected void convert(final ViewHolder holder, ChannelItem channelItem, final int position) {
            final BGABadgeTextView title = null;
            final ImageView drawableLeft = null;

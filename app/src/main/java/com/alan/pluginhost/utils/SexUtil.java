...
import com.alan.pluginhost.listener.SexSelectedListener;
...
public class SexUtil {
    ...
    public static class Sex {
        ...
        static {
            SEX_ARR.add(new Sex(getString(R.string.sex_boy), getString(R.string.sex_tag_boy), R.color.design_default_color_background));
            SEX_ARR.add(new Sex(getString(R.string.sex_girl), getString(R.string.sex_tag_girl), R.color.design_default_color_background));
        }

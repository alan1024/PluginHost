package com.alan.pluginhost.utils.display;
...
public final class DisplayInfoUtils {
    ...
    private static class Holder {
        private static final DisplayInfoUtils INSTANCE = new DisplayInfoUtils(mContext);
    }

    private DisplayInfoUtils(Context mContext) {

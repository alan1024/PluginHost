package com.alan.pluginhost.recylerview.widget;
...
import com.alan.pluginhost.recylerview.adapter.OnItemClickListener;
...
public class WrapRecyclerView extends RecyclerView {
    ...
    public void setAdapter(Adapter adapter) {
        ...
        if (mLongClickListener != null) {
            mWrapRecyclerAdapter.setOnLongClickListener((com.alan.pluginhost.recylerview.adapter.OnLongClickListener) mLongClickListener);
        }
    ...
    public void setOnLongListener(OnLongClickListener longClickListener) {

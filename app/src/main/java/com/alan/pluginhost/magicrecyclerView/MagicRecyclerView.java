...
import static com.alan.pluginhost.magicrecyclerView.BaseRecyclerAdapter.RecyclerItemType.TYPE_TAGS;
...
public class MagicRecyclerView extends RecyclerView {
    ...
    public MagicRecyclerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public MagicRecyclerView(Context context, AttributeSet attrs, int defStyle) {

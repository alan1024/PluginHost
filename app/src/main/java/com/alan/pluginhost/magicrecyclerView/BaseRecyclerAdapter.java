...
public abstract class BaseRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public int getItemViewType(int position) {
        if (mHeaderView == null) {
            if (mFooterView == null) {
                ...
                if (mDatas.get(position).getItemType() == RecyclerItemType.TYPE_NORMAL) { //有头部视图时需要对位置进行纠正
                    return RecyclerItemType.TYPE_NORMAL.getiNum();
                } else if (mDatas.get(position).getItemType() == RecyclerItemType.TYPE_TAGS) {
            ...
            if (mFooterView == null) {
                ...
                if (position == 0) {
                    ...
                    if (mDatas.get(position - 1).getItemType() == RecyclerItemType.TYPE_NORMAL) { //有头部视图时需要对位置进行纠正
                        return RecyclerItemType.TYPE_NORMAL.getiNum();
                    } else if (mDatas.get(position - 1).getItemType() == RecyclerItemType.TYPE_TAGS) {
                        return RecyclerItemType.TYPE_TAGS.getiNum();
                    }
                }
            } else {
                ...
                if (position == 0) {
                    ...
                    if (mDatas.get(position - 1).getItemType() == RecyclerItemType.TYPE_NORMAL) { //有头部和底部视图时需要对位置进行纠正
                        return RecyclerItemType.TYPE_NORMAL.getiNum();
                    } else if (mDatas.get(position - 1).getItemType() == RecyclerItemType.TYPE_TAGS) {
                        return RecyclerItemType.TYPE_TAGS.getiNum();
                    }
        ...
        if (mHeaderView != null) { //包含头部控件时
            if (position == 0) {
                return RecyclerItemType.TYPE_HEADER.getiNum(); //返回HEADER对应的数值
            } else {
                if (mDatas.get(position - 1).getItemType() == RecyclerItemType.TYPE_NORMAL) { //有头部视图时需要对位置进行纠正
                    return RecyclerItemType.TYPE_NORMAL.getiNum();
                } else if (mDatas.get(position - 1).getItemType() == RecyclerItemType.TYPE_TAGS) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, final int viewType) {
        if (mHeaderView != null && viewType == RecyclerItemType.TYPE_HEADER.getiNum())
            return new Holder(mHeaderView);
        if (mFooterView != null && viewType == RecyclerItemType.TYPE_FOOTER.getiNum())
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        if (getItemViewType(position) == RecyclerItemType.TYPE_HEADER.getiNum())
            return;
        if (getItemViewType(position) == RecyclerItemType.TYPE_FOOTER.getiNum())
            return;
        ...
        if (manager instanceof GridLayoutManager) {
            ...
            gridManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
                ...
                public int getSpanSize(int position) {
                    return (getItemViewType(position) == RecyclerItemType.TYPE_HEADER.getiNum() ||
                            getItemViewType(position) == RecyclerItemType.TYPE_FOOTER.getiNum() ||
                            getItemViewType(position) == RecyclerItemType.TYPE_TAGS.getiNum())
    ...
    public void onViewAttachedToWindow(RecyclerView.ViewHolder holder) {
        ...
        if ((holder.getItemViewType() == RecyclerItemType.TYPE_HEADER.getiNum()) ||
                (holder.getItemViewType() == RecyclerItemType.TYPE_FOOTER.getiNum()) ||
                (holder.getItemViewType() == RecyclerItemType.TYPE_TAGS.getiNum())) {

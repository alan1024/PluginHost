...
public class URLImageParser implements Html.ImageGetter {
    ...
    public class ImageGetterAsyncTask extends AsyncTask<String, Void, Drawable> {
        ...
        protected void onPostExecute(Drawable result) {
            ...
            //设置图片显示占据的高度
            int imageWight = 360;
            int imageHeight = result.getIntrinsicHeight() * imageWight / result.getIntrinsicWidth();
        ...
        public Drawable fetchDrawable(String urlString) {
            ...
            try {
                ...
                //设置图片的实际高低
                drawable.setBounds(0, 0, 0 + 360, 0
                        + drawable.getIntrinsicHeight() * 360 / drawable.getIntrinsicWidth());
                return drawable;
            } catch (Exception e) {
                if (is != null)
                    try {
